      ...
      <section className="relative overflow-hidden border-b border-white/[0.06] px-8 pb-12 pt-12 md:px-10 md:pt-14">
        ...
        >
          ...
          {lang === "en" ? (
            ...
            >
              Hi! {"I'm"} Džemil, a{" "}
              <span className="font-medium text-white/80">full-stack engineer</span>{" "}
              and Informatics student at the{" "}
              <span className="font-medium text-white/80">University of Novi Pazar</span>
              . {"I'm"} genuinely passionate about building modern web and mobile
              applications, driven by a constant hunger to{" "}
              <span className="font-medium text-white/80">learn new technologies</span>{" "}
            ...
            <motion.p
              ...
              className="mt-5 max-w-xl leading-relaxed text-muted"
            >
              Zdravo! Ja sam Džemil,{" "}
              <span className="font-medium text-white/80">fullstack inženjer</span>{" "}
              i student Informatike na{" "}
              <span className="font-medium text-white/80">
                Državnom Univerzitetu u Novom Pazaru
              </span>
              . Strastveno radim na izgradnji modernih web i mobilnih aplikacija,
              pokretan stalnom željom za{" "}
              <span className="font-medium text-white/80">učenjem novih tehnologija</span>{" "}
              i napretkom. Kao developer, ponosan sam na to što sam{" "}
              <span className="font-medium text-white/80">
                snalažljiv, uporan i visoko komunikativan
              </span>
              {" "}— uvijek nalazim pametna rješenja za složene probleme i donosim
              snažnu kolaboraciju svakom timu.
            </motion.p>
          )}
        </motion.div>
      </section>
